...
const styles = (theme) => ({
  ...
  const price = ['1', '1.5', '2'];
  const item = ['product1', 'product2', 'product3'];
...
/>
      ...
      options={price}
      fullWidth
      renderInput={(params) => <TextField {...params} label="Price Per/Unit" 
      variant="outlined" 
      color="primary" focused
      sx={{
        input: {
    ...
    />
         ...
         <Grid container gap={10} spacing={2} justifyContent={"center"}>
  ...
  export default(withStyles(styles)(DeliveryOrder1));