  ...
  const handleMouseDownPassword = (event) => {
    ...
    return (
        ...
        <div className=" textCenter">
         ...
         <Button variant="outlined" className={classes.loginBtn} onClick={() => {navigate("/Miscellaneous")}}
            sx={{
                background: "#372a3d",
                borderRadius: "5px",
                width: "20%",
         ...
         <Button variant="outlined" className={classes.loginBtn} onClick={() => {navigate("/SpareParts")}} 
         sx={{
            background: "#372a3d",
            borderRadius: "5px",
            width: "20%",
