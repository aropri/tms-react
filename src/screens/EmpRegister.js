...
const styles = (theme) => ({
  ...
  const type = ['employee', 'client', 'transport'];
    ...
    <br/>
         ...
         <Button variant="outlined" className={classes.loginBtn} onClick={() => {navigate("/EmpRegister1")}} 
         sx={{
            background: "#372a3d",
            borderRadius: "5px",
            width: "20%",
  ...
  export default(withStyles(styles)(EmpRegister));